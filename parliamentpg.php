 ...
 * @since             1.0.0
 * @package           Parliament PG
 *
 * @wordpress-plugin
 * Plugin Name:       Parliament PG
 ...
 */
define( 'PARLIAMENT_PG_VERSION', '1.0.0' );
...
register_activation_hook( __FILE__, 'activate_parliamentpg' );
register_deactivation_hook( __FILE__, 'deactivate_parliamentpg' );
