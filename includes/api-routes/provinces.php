<?php
class Parliament_PG_API_Provinces {
	public function register_route_provinces() {
		register_rest_route('parliament-pg/v1', '/get-provinces', array(
			'methods'  => 'GET',
			'callback' => array($this, 'get_provinces_data'),
	...
	public function get_provinces_data( WP_REST_Request $request ) {
		...
		$external_url = add_query_arg( $query, $endpoints['provinces']['backend']);
